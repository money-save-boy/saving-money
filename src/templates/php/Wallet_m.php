...
<body>
    ...
    <footer>
        <div class="PageChange1" onclick="location.href='/src/spending_year'">
            <p id="pig" class="fa-solid fa-piggy-bank" style="color: #ffffff; font-size: 3em; filter: drop-shadow(0 5px 5px #7e3459);"></p>
        </div>
        <div class="PageChange2">
            <p id="pig" class="fa-solid fa-piggy-bank" style="color: #ffffff; font-size: 3em; filter: drop-shadow(0 5px 5px #7a1d34);"></p>
        </div>
    </footer>
